// Ported from ../ApplicationDetailModal.jsx (Phase 4, Plan 04-03).
// Behavioral additions: the dossier's "open a contact" trigger swaps this body in place for ContactPanelBody (D-05), added in Task 2.
