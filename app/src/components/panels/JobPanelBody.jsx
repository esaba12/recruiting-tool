// Ported from jobBoards/JobDetailModal.jsx into the shared record-panel shell.
...
export default function JobPanelBody({ job, status, blurb, deadline, onRecheckDeadline, onStatusChange, onClose, prefs }) {
